...
const PrivacyPolicyPage = () => {
  return (
    <Layout>
      <Container>
        <h1>Privacy Policy for JLJ Services</h1>
        <p>
          At Japanese Language Jobs Services, accessible from
          <a href="https://japaneselanguagejobsservices.com/">
            https://japaneselanguagejobsservices.com/
          </a>
          , one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by Japanese Language Jobs Services and how we
          use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Japanese Language Jobs Services. This policy
        ...
        <h2>Log Files</h2>
        <p>
          Japanese Language Jobs Services follows a standard procedure of using
        ...
        <p>
          ...
          advertising partners of Japanese Language Jobs Services.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Japanese Language Jobs
          Services, which are sent directly to users' browser. They
        ...
        <p>
          Note that Japanese Language Jobs Services has no access to or control
          over these cookies that are used by third-party advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>
        <p>
          Japanese Language Jobs Services's Privacy Policy does not apply to
        ...
        <p>
          Japanese Language Jobs Services does not knowingly collect any
...
export const Head = () => <Seo title="Privacy Policy Page" />
